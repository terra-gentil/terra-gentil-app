...
const styles = StyleSheet.create({
  ...
  plantSci: { fontSize: 15, color: "#888", fontStyle: "italic", marginTop: 4 },
  confidence: { fontSize: 15, color: "#2E7D32", marginTop: 8, fontWeight: "600" },
  ...
  diagText: { fontSize: 15, color: "#5d4037", lineHeight: 20 },
  ...
  toxicText: { fontSize: 15, color: "#555", lineHeight: 20 },
  ...
  problemDesc: { fontSize: 15, fontWeight: "700", color: "#424242" },
  problemCause: { fontSize: 15, color: "#666", marginTop: 4 },
  planSection: { marginBottom: 16 },
  planSummary: { fontSize: 15, color: "#555", lineHeight: 20, marginBottom: 16, fontStyle: "italic" },
  ...
  reminderText: { fontSize: 15, color: "#1565c0" },
