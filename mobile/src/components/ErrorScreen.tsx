...
const ERROR_CONTENT: Record<ErrorCode, ErrorContent> = {
  [ErrorCode.NETWORK_OFFLINE]: {
    ...
    checklist: [
      "Seu Wi-Fi está ligado?",
      "Os dados móveis estão ativos?",
      "O modo avião está desligado?",
    ],
    dica: "Quando a conexão voltar, toque em Tentar de novo.",
  ...
  [ErrorCode.NETWORK_TIMEOUT]: {
    ...
    description: "Nosso servidor está com muitos pedidos agora. Isso acontece em horários de pico.",
  ...
  [ErrorCode.BACKEND_UNAVAILABLE]: {
    ...
    description: "Nosso servidor está passando por uma atualização rápida. Volta já, já.",
  ...
  [ErrorCode.BACKEND_ERROR]: {
    ...
    description: "Não consegui analisar essa foto agora, mas não é culpa sua. Nosso servidor encontrou um problema interno.",
    checklist: [
      "Tire outra foto com boa iluminação",
  ...
  [ErrorCode.INVALID_RESPONSE]: {
    ...
    description: "Aconteceu algo inesperado. Pode acontecer de vez em quando, não se preocupe.",
  ...
  [ErrorCode.IMAGE_TOO_LARGE]: {
    ...
    dica: "Escolha outra foto ou tire uma nova com a câmera.",
  ...
  [ErrorCode.IMAGE_INVALID]: {
    ...
    iconColor: COLORS.coral,
    iconBg: COLORS.coralSoft,
    title: "Não consegui ler essa imagem",
    description: "A foto pode estar em um formato que não reconheço ou ter algum problema.",
  ...
  [ErrorCode.PERMISSION_DENIED]: {
    ...
    title: "Preciso de uma autorização",
    description: "Para funcionar, o Terra Gentil precisa de permissão para acessar a câmera ou galeria.",
    dica: "Libere a permissão nas configurações do celular.",
  ...
  [ErrorCode.UNKNOWN]: {
    ...
    description: "Não consegui terminar a ação, mas não é culpa sua.",
