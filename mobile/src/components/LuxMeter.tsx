...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 15, fontWeight: "800", color: "#555", textTransform: "uppercase", marginBottom: 12, textAlign: "center" },
  labels: { flexDirection: "row", justifyContent: "space-between", marginBottom: 4 },
  labelText: { fontSize: 13, color: "#999" },
  ...
  verdict: { fontSize: 15, fontWeight: "700", color: "#2E7D32", textAlign: "center" },
});
